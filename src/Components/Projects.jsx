...
function Projects() {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-3 gap-x-4 gap-y-4'>
      ...
      <Card projectTitle={"Mela"} link="https://github.com/ManthanChaudhari/ChatWebApp" projectImage={mela} description="It uses WebSocket for real-time communication and integrates Appwrite for secure authentication. Users can seamlessly join or initiate meetings with friends for interactive collaboration." techstack={"React, Redux, Tailwind Css, Websocket, Appwrite"}/>
    </div>
  )
}

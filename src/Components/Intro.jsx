  ...
  return (
    ...
    <Lottie animationData={heroImage} className="w-full lg:w-[500px]" />
      ...
      <div className='text-left  lg:h-96 flex flex-col justify-center px-2 lg:gap-y-4 gap-y-3 font-bold'>
         ...
         <p className=' font-normal text-left md:w-80 lg:w-96'>I am 19 year old, doing BS in Computer Science, 
         passionate about crafting innovative web apps, 
         seeking an internship to further develop skills and contribute to the tech world's evolution.</p>
         <Button text='Download Resume' className='bg-blue-500 active:bg-blue-400 transition-all'/>
      </div>
    </div>
  )
}
